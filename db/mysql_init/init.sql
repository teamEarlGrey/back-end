...
-- data
INSERT INTO rooms(room_no, memo, is_detected)
  VALUES("1201", "コンセントプラグ：床", 0),
		("1202", "コンセントプラグ：床", 0),
		("1203", "コンセントプラグ：床", 0),
		("1204", "コンセントプラグ：床", 0),
        ("1205", "コンセントプラグ：床", 0),
		("2301", "コンセントプラグ：机の上, ネットワーク機器あり", 0),
		("4301", "コンセントプラグ：床", 0),
		("3301", "コンセントプラグ：机の横", 0),
		("2302", "コンセントプラグ：机の上", 0),
		("4203", "コンセントプラグ：床", 0),
        ("2031", "コンセントプラグ：机の上, ネットワーク機器あり", 0);


INSERT INTO rooms(room_no, memo, is_detected)
	VALUES("2405", "コンセントプラグ：机の横", 0),
		  ("2402", "コンセントプラグ：床", 0),
		  ("3502", "コンセントプラグ：机の上", 0),
		  ("1403", "コンセントプラグ：机の上", 0),
		  ("4202", "コンセントプラグ：床", 0),
